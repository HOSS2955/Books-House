...
const {login ,sendCode,forgetPassword} = require('../controller/admin.controller');

const {validation}= require('../middelware/validation')
const {loginValidation,forgetPasswordValidation,sendCodeValidation}=require('../validation/adminValidation')
