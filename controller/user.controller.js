...
const signUp=async (req,res)=>{
    ...
    res.status(201).json({message:"please check your email to verify it",savedUser})
...
const login = async (req, res) => {
    ...
    //---------------------------------------------------------forget password  
     const forgetPassword=async (req,res) => {
        ...
        await User.findByIdAndUpdate({_id:user._id},{password:hashPassword,code:' '})
...
const addProfileAvatar = async (req,res)=>{
    try {
        ...
        res.status(500).send(e.message)
            ...
            module.exports = {confirmEmail,refreshEmail,login,sendCode,forgetPassword,signUp,updateProfile,addProfileAvatar}