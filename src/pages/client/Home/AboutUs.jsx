  ...
  return (
    <div className="container mb-5">
      <div className="row mb-5">
        ...
        <div className="home__about col-md-6 col-sm-12">
        <h5 className="fw-bold mb-4 ">Who We Are ?</h5>
          <p className="text-muted">
            ...
            consultation services that are the best in the market. We are
            dedicated to work hard in order to escort our clients to their
            ultimate goals.
          </p>
        </div>
      </div>
