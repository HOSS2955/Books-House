...
export default function Reviews() {
  ...
  // const bookReveiwData = bookReviewApiSlice.endpoints.getBookReviews.select();
  // const bookReveiwData = (state) =>
  //   bookReviewApiSlice.endpoints.getBookReviews.select()(state).data;
  ...
  const { data, isSuccess, isLoading, isFetching, refetch } =
    useGetBookReviewsQuery(null, {
      refetchOnMountOrArgChange: true,
      // tags: ["REVIEWS"],
    });
  // }
  let bookReviews = isSuccess ? data : [];
  ...
  // let myData = "";
  const [deleteBookReview, { isError: deleteError, isLoading: deleteLoading }] =
    useDeleteBookReviewMutation();
  // const myState =
  //   bookReviewApiSlice.endpoints.getBookReviews.useQueryState(null);
  // console.log("cach data", myState.currentData);
  // console.log("API data", myState.data);
  // const myReview = bookReviewApiSlice.endpoints.getBookReviews.select();
  // console.log("myReview", myReview("getBookReviews"));

  const theme = useTheme();
  const colors = tokens(theme.palette.mode);
  // console.log(bookReveiwData());
